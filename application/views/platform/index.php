<p>
    ...
    <a class="btn " href="<?= base_url(); ?>platform/edit"><i class="plus"></i>Create new</a>
</p>
            ...
            <li class=" span3">
                <div class="thumbnail">
                    ...
                    <div class="caption center">
                        ...
                        <a href="<?php echo base_url() ?>platform/edit/<?php echo $item->id ?>" class="btn"><i class="edit"></i>Edit</a>
