...
<?php echo form_open('', array('id'=>'edit-form', 'class'=>'form-horizontal')) ?>    
    ...
    <legend>
        ...
        <fieldset class="control-group">
            ...
            <div class="controls">
                <input type="text" name = "platform_id" id = "platform_id" class = "input-xxlarge" value = "<?php echo $_POST && isset($_POST['platform_id']) ? $_POST['platform_id'] : ($item ? $item->platform_id : '') ?>"/>
            </div>
        </fieldset>  
        <fieldset class="control-group">
