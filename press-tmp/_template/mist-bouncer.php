    ...
    <div class="row cols">
        <div class="span5 col" style="text-align:center">
            <div class="span5" style="margin-top:10px;">
                <img src="<?php echo base_url() ?>images/mb.png" alt="">
            </div>   
            <h3>Mist Bouncer</h3>         
            <h5>Released December 2011</h5>
            <p>
                <a class="btn primary large" href = "#" data-ga = "1" data-ga-category = "Outbound link" data-ga-action = "click" data-ga-label = "Mist Bouncer download pack" data-ga-value = "1">Download press pack</a>
            </p>
            <p>
        ...
        <div style="padding:10px;">
            <div class="row" style="margin-bottom:20px;">
                <div class="span7">
                    ...
                    <p>
                        Title: <strong>Mist Bouncer</strong>
                    </p>
                </div>
                <div class="span8">
                    <p>
            ...
            <h4>
                Invictus to roll out Mist Bouncer, a fun jumping game placed in the same Mistbound universe as Greed Corp
            </h4>
            <!-- 
            <p>
